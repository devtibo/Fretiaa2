...
XYRangeDialog::XYRangeDialog(QWidget *parent, double x1, double x2)
    : QDialog(parent)
{
...
double XYRangeDialog::getLowerLimit() const
{
 return val1;
}

void XYRangeDialog::setLowerLimit(const double val1)
{
    this->val1 = val1;
}

double XYRangeDialog::getHigerLimit() const
{
    return val2;
}

void XYRangeDialog::getHigerLimit(const double val2)
{
    this->val2 = val2;
}
